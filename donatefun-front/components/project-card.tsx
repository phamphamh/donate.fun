      ...
      >
        <div className="relative overflow-hidden">
          ...
          <div className="absolute top-3 right-3 z-20">
            <Badge className={`${categoryColor} border-none`}>{project.category}</Badge>
          </div>

          <div
            className="absolute bottom-3 left-3 right-3 transition-transform duration-300 z-20"
            style={{ transform: isHovered ? "translateY(0)" : "translateY(10px)", opacity: isHovered ? 1 : 0 }}
          >
            <Link href={`/project/${project.id}`}>
              <Button size="sm" className="w-full bg-white text-indigo-600 hover:bg-indigo-50 shadow-md">
                Quick View
              </Button>
            </Link>
          </div>

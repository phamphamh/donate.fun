...
export default function CreateCheckpoints({ checkpoints, onChange }: CreateCheckpointsProps) {
  const [error, setError] = useState<string | null>(null)

  const addCheckpoint = () => {
    const newCheckpoints = [...checkpoints, { title: "", description: "", percentage: 0 }]
    ...
    <div className="space-y-4">
        ...
        <Card key={index}>
          <CardContent className="p-4">
            ...
            <div className="grid gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor={`checkpoint-${index}-description`}>Description</Label>
                <Textarea
              ...
              <div className="space-y-2">
                <Label htmlFor={`checkpoint-${index}-percentage`}>Percentage of Total Funding (%)</Label>
                <Input
                  ...
                  onChange={(e) => updateCheckpoint(index, "percentage", Number.parseInt(e.target.value) || 0)}
                  required
                />
              </div>
            </div>
      ...
      <div className="bg-blue-50 p-4 rounded-md">
        ...
        <ul className="list-disc pl-5 space-y-1 text-sm text-blue-600">
          <li>Break your project into logical stages that donors can easily understand</li>
          <li>Each checkpoint should have a clear, measurable outcome</li>
          <li>Allocate funding percentages based on the resources needed at each stage</li>
          <li>You'll need to provide proof of completion for each checkpoint to receive funds</li>
        </ul>
      </div>
    </div>
  )
